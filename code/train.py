...
def train(config, training_chunked_samples_dir, testing_chunked_samples_file):
    ...
    if not config["pretrained"]:
        ...
        model_state_dict, optimizer_state_dict, step = loader(config["ML_MemAE_SC_pretrained"])
...
if __name__ == '__main__':
    ...
    if dataset_name == 'carla_local':
        ...
        testing_chunked_samples_file = 'carla_data/STC/testing/chunked_samples/chunked_samples_00_old.pkl'
