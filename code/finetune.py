...
if __name__ == '__main__':
    ...
    if dataset_name == 'carla_local':
        ...
        testing_chunked_samples_file = '/disk/users/hb344/no_backup/Desktop/hf2vad/carla_data/STC/testing/chunked_samples/chunked_samples_00_old.pkl'
